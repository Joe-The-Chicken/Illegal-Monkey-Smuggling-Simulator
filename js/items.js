...
class Drink {
    constructor(value, thirsty, description, alchoholic) {
        this.type = "drink";
        this.value = value;
        this.thirsty = thirsty;
        if (alchoholic) {
            this.alchoholic = alchoholic;
            this.description = `${description}\n - Worth $${value}\n - Replenishes ${thirsty} Thirst\n - This item is alcoholic. You will be high for 5 ingame ticks`;
        } else {
            this.alchoholic = false;
            this.description = `${description}\n - Worth $${value}\n - Replenishes ${thirsty} Thirst`;
        }
    }
}
...
let itemList = {
    ...
    "Suspicious Soda": new Drink(10, 50, "Dont drink this around police officers.", true),
    "Wooden Desk": new Fuel(8, 14, "It's missing a leg."),
    "Plant": new Scrap(3, "Somehow it's doing better than when it had an owner."),
    "Floor Lamp": new Scrap(5, "It's conveniently sized."),
    "Cash Register": new Scrap(4, "All the money is gone."),
    "Key": new Scrap(1, "It doesn't unlock anything."),
    "Poster": new Scrap(2, `It uses an archaic form of language known as "Emojis".`),
    "Gold Bars": new Valuable(150, "Shiny!"),
    "Money Pile": new Valuable(100, "Perfect for gambling."),
    "Crown": new Valuable(60, "Someone took all of the gems.")
};